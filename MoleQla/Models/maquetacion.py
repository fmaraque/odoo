...
class maquetacion(models.Model):
    ...
    maquetador_id = fields.Many2one('res.users','Maquetador')
    ...
    articulo_seccion = fields.Many2one(related='articulo_id.seccion_id', string='Sección', codel_name='seccion', readonly=True)
