...
<div class="sticky-nav">
    ...
    <nav id="menu">
        <ul id="menu-nav">
            ...
            <li class="current"><html:link action="/revista/work/work" styleClass="external">Revistas</html:link></li>
            <li><html:link action="/revista/about/about" styleClass="external">Equipo Editorial</html:link></li>
